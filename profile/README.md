...
### 2. Sensor Tracking Setup 📡
Install the Python environment and calibrate the acceleration sensors on the gloves.
* 👉 **Go to:** [`BeatBoxingSensorTracking`](https://github.com/BeatBoxingProject/BeatBoxingSensorTracking) for dependency installation and acceleration sensor tuning setps.
